        ...
        public static void SeedingData(DataContext _context)
        {
            ...
            if (!_context.Products.Any())
            {
                CategoryModel Macbook = new CategoryModel
                {
                    Name = "MacBook",
                    Slug = "MacBook",
                    Description = "Thuong hieu noi tieng the gioi",
                    Status = 1
                };
                CategoryModel ROG = new CategoryModel
                {
                    Name = "Asus",
                    Slug = "ROG",
                    Description = "Thuong hieu noi tieng the gioi",
                ...
                CategoryModel Dell = new CategoryModel
                {
                    Name = "Dell",
                    Slug = "Dell",
                    Description = "Thuong hieu noi tieng the gioi",
                ...
                CategoryModel MSI = new CategoryModel
                {
                    Name = "MSI",
                    Slug = "MSI",
                    Description = "Thuong hieu noi tieng the gioi",
                ...
                CategoryModel Lenovo = new CategoryModel
                {
                    Name = "Lenovo",
                    Slug = "Lenovo",
                    Description = "Thuong hieu noi tieng the gioi",
